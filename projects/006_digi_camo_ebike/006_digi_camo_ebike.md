...
If you're building an ebike with a large motor it just makes sense to buy a frame that is meant to accommodate a big motor. Large dropouts that are heavily reinforced, a large open area for the battery (and a means to carry it). It's not that you can't do it on a regular mountain bike frame, it just poses a lot more problems and if you're ever built a bike like this, trust me there will be problems already. 
